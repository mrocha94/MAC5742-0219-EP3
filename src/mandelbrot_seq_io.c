...
void init(int argc, char *argv[]) {
  if (argc < 6) {
    ...
    printf("    Seahorse Valley:      ./mandelbrot_seq -0.8 -0.7 0.05 0.15 "
           "11500\n");
    printf("    Elephant Valley:      ./mandelbrot_seq 0.175 0.375 -0.1 0.1 "
           "11500\n");
    printf("    Triple Spiral Valley: ./mandelbrot_seq -0.188 -0.012 0.554 "
           "0.754 11500\n");
    exit(0);
  } else {
